	...
	tests := []struct {
		...
		},
		{
			...
			item: &Item{
				Title:    "Task",
				Status:   StatusNotStarted,
				Modified: time.Date(2024, 2, 2, 12, 0, 0, 0, time.UTC),
			},
			want: &Item{
				Title:    "Task",
				Status:   StatusNotStarted,
...
func TestItem_Equivalent(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name: "equivalent when StatusOpen and StatusNotStarted",
			item: baseItem,
			other: &Item{
				ID:             "1",
				ExternalID:     new("ext-1"),
		...
		{
			name: "equivalent when StatusOpen and StatusInProgress",
			item: baseItem,
			other: &Item{
				ID:             "1",
				ExternalID:     new("ext-1"),
		...
		{
			name: "equivalent when StatusNotStarted and StatusOpen",
			item: &Item{
				ID:             "1",
				ExternalID:     new("ext-1"),
				ListID:         "list-1",
		...
		{
			name: "equivalent when StatusInProgress and StatusOpen",
			item: &Item{
				ID:             "1",
				ExternalID:     new("ext-1"),
				ListID:         "list-1",
		...
		{
			name: "different Statuses (active vs done)",
			item: &Item{
				ID:             "1",
				ExternalID:     new("ext-1"),
				ListID:         "list-1",
		...
		{
			name: "different WaitingOn string",
			item: baseItem,
			other: &Item{
				ID:             "1",
				ExternalID:     new("ext-1"),
		...
		},
		{
			...
			other: &Item{
				...
				Created:        baseItem.Created.Add(time.Hour),
			},
			want: true,
		},
		{
