...
func TestItem_Equivalent(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name: "equal when one ProjectID is nil",
			item: baseItem,
			other: &Item{
				ID:             "1",
				ExternalID:     new("ext-1"),
		...
		{
			name: "equal when one ExternalProjectID is nil",
			item: baseItem,
			other: &Item{
				ID:                "1",
				ExternalID:        new("ext-1"),
		...
		{
			name: "different ExternalProjectIDs when both set",
			item: &Item{
				ID:                "1",
				ExternalID:        new("ext-1"),
				ListID:            "list-1",
			...
			other: &Item{
				...
				ListID:            "list-1",
				ExternalListID:    new("ext-1"),
				ExternalProjectID: new("ext-proj-2"),
				Title:             "Task",
				Description:       "Desc",
				Status:            StatusOpen,
				Position:          0,
		...
		{
			name: "different ProjectTag pointers (one nil)",
			item: baseItem,
			other: &Item{
				ID:             "1",
				ExternalID:     new("ext-1"),
		...
		{
			name: "different ProjectTags when both set",
			item: baseItem,
			other: &Item{
				ID:             "1",
				ExternalID:     new("ext-1"),
